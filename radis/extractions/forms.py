...
from .models import DataField, ExtractionJob, FilterField
...
class FilterFieldFormSetHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class DataFieldFormSetHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
DataFieldFormSet = forms.inlineformset_factory(
    ExtractionJob,
    DataField,
    form=DataFieldForm,
    extra=1,
