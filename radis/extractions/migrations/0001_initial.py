...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("procrastinate", "0031_add_indexes_for_fetch_job"),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("filter_fields_result", models.JSONField(blank=True, null=True)),
                ("data_fields_result", models.JSONField(blank=True, null=True)),
                (
                    "report",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="extraction_instances",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("name", "job_id"), name="unique_data_field_name_per_job"
            ),
        ),
        migrations.AddConstraint(
            model_name="filterfield",
            constraint=models.UniqueConstraint(
                fields=("name", "job_id"), name="unique_filter_field_name_per_job"
            ),
        ),
    ]
